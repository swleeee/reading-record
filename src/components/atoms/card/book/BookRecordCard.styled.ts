...
export const bookRecordCard = css`
  ${tw` relative flex gap-x-[19px] w-[300px] h-[140px] rounded-[4px] px-[12px] py-[18px] bg-gray50 shadow-light_md hover:bg-brown50`}
`;

// TODO: 스타일 컴포넌트명 적절한 것으로 수정
export const Line = tw.div`absolute top-0 left-0 w-[6px] h-full rounded-l-[4px] bg-brown500`;

export const BookCoverImg = tw.img`h-full object-cover`;
