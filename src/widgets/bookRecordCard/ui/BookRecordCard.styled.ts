...
export const bookRecordCard = css`
  ${tw`relative flex gap-x-[19px] min-w-[208px] w-full h-[148px] rounded-[4px] px-[12px] py-[18px] bg-white shadow-light_md hover:(bg-light-brown-50 dark:bg-dark-grey-250) dark:(dark-bg-grouped-base shadow-dark_md)`}
`;
...
export const UserName = tw.span`flex-1 m-body-r14 text-left text-ellipsis overflow-hidden whitespace-nowrap dark:text-white tablet:t-body-r14 desktop:d-body-r16`;
...
export const RecordContent = styled.p<{ device: DeviceType }>`
  ${({ device }) => css`
    ${tw`m-body-r12 text-left text-ellipsis break-all overflow-hidden dark:text-white tablet:t-body-r14 desktop:d-body-r14`}
